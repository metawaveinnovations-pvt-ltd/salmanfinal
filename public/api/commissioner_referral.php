<?php
/**
 * PHP Endpoint: Secure Commissioner Referral Processing (Separate Table)
 */
...
try {
    $sql = "INSERT INTO commissioner_referrals (
                commissioner_name, 
                authority, 
                email, 
                phone, 
    ...
    $stmt->execute([
        ...
        ':risk_details'      => !empty($riskDetails) ? $riskDetails : null,
